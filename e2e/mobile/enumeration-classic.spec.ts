...
// Same flow as e2e/desktop/enumeration-classic.spec.ts, run under the
// "mobile" Playwright project (Pixel 7 viewport/touch emulation) to catch
// responsive layout regressions on phone-sized screens.
